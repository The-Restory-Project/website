      ...
      <div className="row padding-vertical">
        <div className="col-md-6">
          ...
          <p>
            ...
            with adolescents and adults, both online and offline, and on issues
            such as: depression, anxiety, trauma, addiction and interpersonal
            difficulties/relationship concerns.
            <br />
            <br />
            She is currently working in an academic setting as well as in
            private practice. She is passionate about helping women and LGBTQIA+
            clients in finding a safe space and creating supportive networks.
            Her orientation is primarily cognitive behaviour therapy, but she is
            also heavily influenced by existential, humanistic and narrative
            therapy.
            <br />
            <br />
            She is a poet on the side, and is interested in exploring the use of
            poetry and other expressive arts in therapy.
          </p>
        </div>
        ...
        <div className="col-md-6">
          ...
          <p>
            ...
            specialises in grief, trauma, body image, anxiety, depression,
            personal growth and relationship/family/workplace concerns.
            <br />
            <br />
            ...
            school, work and private settings, using offline and online mediums.
            She regularly takes feedback from her clients and considers it a
            critical part of the therapeutic process.
            <br />
            <br />
            Anvitha has a Masters in Counseling Psychology and has also studied
            Psychology in her undergrad. She loves fantasy movies because they
            hold hope for her "even in the darkest of times".
          </p>
        </div>
      </div>
    </div>
